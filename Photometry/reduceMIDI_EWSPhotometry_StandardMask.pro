...
pro reduceMIDI_EWSPhotometry_StandardMask
...
photpath = '/media/disk/MIDI_FSUA/COMM'+commnum+'/MIDIdata/Photometry/'
reddir = '/media/disk/MIDI_FSUA/COMM'+commnum+'/MIDIreduced_EWS_StandardMask/'
