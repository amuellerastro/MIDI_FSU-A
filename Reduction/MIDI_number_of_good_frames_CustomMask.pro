...
pro MIDI_number_of_good_frames_CustomMask
...
pathews = 'MIDIreduced_EWS_CustomMask/'
pathcohint = 'MIDIreduced_CohInt_CustomMask/'
pathkoresko = 'MIDIreduced_Koresko_CustomMask/'
...
openw, lun, resultpath+'MIDI_good_frames_CustomMask.txt', width=1400, /get_lun
