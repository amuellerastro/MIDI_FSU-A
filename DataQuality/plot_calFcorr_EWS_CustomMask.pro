pro plot_calFcorr_EWS_CustomMask
...
resultpath = mainpath+'Plots_CalFcorr_EWS_CustomMask/'
...
;for i=3,3 do begin
  ...
  set_plot, 'ps'
  device, isolatin=1
  device, filename=resultpath+id[i]+'_'+time[i]+'_CalFcorr_EWS_CustomMask.ps', /color,XSIZE=17, YSIZE=10, XOffset=xoffset, YOffset=yoffset
...
;   oploterror, wl, fcorr3, fcorrerr3, color=fsc_color('red'), errcolor=fsc_color('red'), /nohat
  ...
  spawn, 'gv '+resultpath+id[i]+'_'+time[i]+'_CalFcorr_EWS_CustomMask.ps'
